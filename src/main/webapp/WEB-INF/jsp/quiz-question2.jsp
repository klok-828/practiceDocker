...
<div>
    <form method="post" action="/quiz-question2">
            Question:
            ${quizQuestions[1].description}
            </br>
            </br>
            Choose from:
            </br>
            <c:forEach items="${question2Choices}" var="choice">
                <input type="radio" name="selectedQ2Choice" value="${choice.description}">${choice.description}
            </c:forEach>
                </br>
            ...
            <a href="quiz-question1">pre</a>
            <a href="quiz-question3">next</a>
            </br>
