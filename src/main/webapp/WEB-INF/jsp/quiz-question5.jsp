...
<div>
    <form method="post" action="/quiz-question5">
                Question:
                ${quizQuestions[4].description}
                </br>
                </br>
                Choose from:
                </br>
                <c:forEach items="${question5Choices}" var="choice">
                    <input type="radio" name="selectedQ5Choice" value="${choice.description}">${choice.description}
                </c:forEach>
                    </br>
