...
<div>
    <form method="post" action="/quiz-question3">
                Question:
                ${quizQuestions[2].description}
                </br>
                </br>
                Choose from:
                </br>
                <c:forEach items="${question3Choices}" var="choice">
                    <input type="radio" name="selectedQ3Choice" value="${choice.description}">${choice.description}
                </c:forEach>
                    </br>
                ...
                <a href="quiz-question2">pre</a>
                <a href="quiz-question4">next</a>
                </br>
